...
public class TutorialPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Tutorial";
	...
	private TutorialPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TutorialPersistentManager();
		}
