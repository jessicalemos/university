...
public class Tutorial1PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Tutorial1";
	...
	private Tutorial1PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Tutorial1PersistentManager();
		}
